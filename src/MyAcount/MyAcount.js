...
function MyAcount(params) {
  ...
  return (
    <div>
      ...
      {!buyerDataOrders || !buyerData || !Loggedin ? (
          ...
          <div class="row">
            <div class="col-md-2 border-right">
              <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                ...
                <span class="font-weight-bold">
                  {Loggedin.displayName || buyerData.FullName}
                </span>
                <span class="text-black-50">{Loggedin.email}</span>
                <span> </span>
              </div>
            </div>
                ...
                <div class="row mt-2">
                  <div class="col-md-6">
                    ...
                    <input
                      ...
                      value={Loggedin.displayName || buyerData.FullName}
                    />
                  </div>
                  <div class="col-md-6">
            ...
            <div class="col-md-5 overflower">
              ...
              {!buyerDataOrders ? (
                ...
                <div class="  bg-light">
                  {buyerDataOrders.length === 0 ? (
                    <h3>No Order History</h3>
                  ) : (
                    buyerDataOrders.map(
                      x => (
                        <h4 onClick={handleShow} className="text-center">
                          OrderID:{" "}
                          <h7
                            onClick={() => orderDetailHandler(x._id)}
                            class="text-dark orderDetailButton"
                          >
                            {x._id}
                          </h7>
                        </h4>
              ...
              <Modal show={show} onHide={handleClose}>
                {!OrderDescription ? (
                  ...
                  <>
                    <Modal.Header>
                      <Modal.Title class="d-flex justify-content-center align-items-center">
                        <p>
                          Total Payable Amount : ${OrderDescription.Payment}
                        </p>{" "}
                        <Button className="ml-3" variant="dark">
                        ...
                        <div class="media mb-2 border-bottom" key={element._id}>
                          <div class="media-body">
                            ...
                            <div class="small text-muted">
                              Price: ${element.price}{" "}
                              <span class="mx-2">|</span> Qty: {element.qty}{" "}
      ...
      <div className="d-flex justify-content-center align-items-center">
        <button
          type="button"
          class="btn btn-outline-secondary px-5 py-2 my-3"
          onClick={logout}
        >
          Log Out
        </button>
