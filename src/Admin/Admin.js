...
useEffect(()=>{async function fetchData() {
  fetch('http://mern-com.herokuapp.com/User')
  .then(res=>res.json())
...
const removeUser= async (item)=>{
  await fetch(`http://mern-com.herokuapp.com/User/${item}`, {
    method: 'DELETE',
    headers: {
...
const [DataOrder,setDataOrder]=useState([])
    useEffect(()=>{async function fetchDataPwd() {
      fetch('http://mern-com.herokuapp.com/Orders')          
...
const [DataPwd,setDataPwd]=useState([])
  ...
  const removeProduct= async (item)=>{ 
    await fetch(`http://mern-com.herokuapp.com/Products/${item}`, {
      method: 'DELETE',
      headers: {
          'Content-type': 'application/json'
      }
...
const UpdateProduct= async  (e)=>{
  ...
  setClicked(true)
    ...
    console.log(images)
    //  console.log()
      await fetch(`http://mern-com.herokuapp.com/Products/${Pwd._id}`, {
      method: 'PATCH',
      headers: {
          'Content-type': 'application/json'
      },
...
const submitHandler= async (e ) =>{
  ...
  console.log(images)
   const res = await fetch('http://mern-com.herokuapp.com/Products',{
    method:'POST',
    headers:{
    'Content-Type':'application/json'
    },
...
const categroySubmit= async (e)=>{
  ...
  setClicked(true);  
   const res = await fetch('http://mern-com.herokuapp.com/Category',{
    method:'POST',
    headers:{
    'Content-Type':'application/json'
    },
...
const GallerySubmit= async (e)=>{
  ...
  // console.log(Category,imgnamegallary,imageurlgallary)
   const res = await fetch('http://mern-com.herokuapp.com/Gallery',{
    method:'POST',
    headers:{
    'Content-Type':'application/json'
    },
...
const handleUpdateOrderStatus = async (Pwd)=> {
  console.log(Pwd._id)
  await fetch(`http://mern-com.herokuapp.com/Orders/${Pwd._id}`, {
    method: 'PATCH',
    headers: {
        'Content-type': 'application/json'
    },
